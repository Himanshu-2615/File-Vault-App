...
function gql(n2) {
  ...
  for (var p3 = 0; p3 < o2.length; p3++) {
    for (var d4 = 0; d4 < o2[p3].definitions.length; d4++) {
      var v3 = o2[p3].definitions[d4];
      if (v3.kind === e.FRAGMENT_DEFINITION) {
        var l3 = v3.name.value;
        var f3 = stringifyDocument(v3);
        if (!a2.has(l3)) {
          a2.set(l3, f3);
          i3.push(v3);
        } else if (a2.get(l3) !== f3) {
          console.warn("[WARNING: Duplicate Fragment] A fragment with name `" + l3 + "` already exists in this document.\nWhile fragment names may not be unique across your source, each name must be unique per document.");
        }
      } else {
        i3.push(v3);
      }
...
var ssrExchange = (e3 = {}) => {
  ...
  var ssr = ({ client: i4, forward: o2 }) => (s) => {
    var c3 = e3 && "boolean" == typeof e3.isClient ? !!e3.isClient : !i4.suspense;
...
var debugExchange = ({ forward: e3 }) => {
  if (false) {
    ...
    return (r3) => onPush((e4) => console.debug("[Exchange debug]: Completed operation: ", e4))(e3(onPush((e4) => console.debug("[Exchange debug]: Incoming operation: ", e4))(r3)));
  }
};
...
function useQuery(e3) {
  ...
  var [p3, h2] = r2.useState(() => [v3, computeNextState(d3, f3(v3, n2)), l3]);
  var x = p3[1];
  if (v3 !== p3[0] && hasDepsChanged(p3[2], l3)) {
    h2([v3, x = computeNextState(p3[1], f3(v3, n2)), l3]);
  }
  r2.useEffect(() => {
    var e4 = p3[0];
    var r3 = p3[2][1];
...
function useSubscription(e3, t2) {
  ...
  var u3 = r2.useRef(t2);
  u3.current = t2;
  var s = r2.useMemo(() => !e3.pause ? a2.executeSubscription(n2, e3.context) : null, [a2, n2, e3.pause, e3.context]);
  var c3 = [a2, n2, e3.context, e3.pause];
  var [v3, f3] = r2.useState(() => [s, {
    ...d3,
    fetching: !!s
  }, c3]);
  var l3 = v3[1];
  if (s !== v3[0] && hasDepsChanged(v3[2], c3)) {
    f3([s, l3 = computeNextState(v3[1], {
      fetching: !!s
    }), c3]);
  }
  r2.useEffect(() => {
    var updateResult = (e4) => {
      deferDispatch(f3, (r3) => {
        ...
        if (u3.current && null != t3.data && r3[1].data !== t3.data) {
  ...
  var p3 = r2.useCallback((r3) => {
    ...
    deferDispatch(f3, (e4) => [t3, e4[1], c3]);
